      ...
      >
        <ul class="cart-list">
          ...
          <li class="cart-list-con4">
            <a class="mins" @click="numHandler('minus', -1, cartInfo)">-</a>
            <input
              @change="numHandler('change', $event.target.value, cartInfo)"
              autocomplete="off"
              type="text"
              minnum="1"
              class="itxt"
            ...
            />
            <a class="plus" @click="numHandler('plus', 1, cartInfo)">+</a>
          </li>
          <li class="cart-list-con5">
            <span class="sum">{{ cartInfo.skuNum * cartInfo.skuPrice }}</span>
          </li>
          <li class="cart-list-con6">
            <a class="sindelet" @click="removeCart(cartInfo.skuId)">删除</a>
            <br />
            <a>移到收藏</a>
          </li>
        </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async numHandler(type, newVal, cartInfo) {
        let offset = 0
        switch (type) {
          case "minus":
            offset = cartInfo.skuNum > 1 ? -1 : 0
            break
          case "plus":
            offset = 1
            break

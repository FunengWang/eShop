      ...
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money">￥{{ paymentInfo.totalFee }}</em></span
          >
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState({
        paymentInfo: (state) => state.pay.paymentInfo,
      }),
    },
    methods: {
      async open() {
        ...
        if (!this.timer) {
          this.timer = setInterval(async () => {
            let result = await this.$store.dispatch("getPayStatus", this.orderId)

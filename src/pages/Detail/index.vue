    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <!-- 小图列表 -->
          <ImageList :list="skuInfo.skuImageList || [{}]" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in saleAttrList" :key="saleAttr.id">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(["categoryView", "skuInfo", "saleAttrList"]),
    },
    methods: {
    ...
    mounted() {
      this.$store.dispatch("goodInfoList", this.$route.params.skuid)
    },
  }
</script>

  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="address.id"
      >
        <span class="username" :class="{ selected: address.idDefault == 1 }">{{
          address.consignee
        }}</span>
        <p>
          <span class="s1">{{ address.fullAddress }}</span>
          <span class="s2">{{ address.phoneNum }}</span>
          <span class="s3" v-show="address.idDefault == 1">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ defaultAddress.consignee }}</span> 电话:
        <span>{{ defaultAddress.phoneNum }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a class="subBtn" @click="submitOrder(orderInfo.tradeNo)">提交订单</a>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      defaultAddress() {
        return (
          this.addressList.find((element) => element.idDefault == 1) || {
            consignee: "习近平",
            fullAddress: "北京市西城区西长安街街道中南海",
            phoneNum: "19599995555",
          }
        )
      },
    },
